...
public class simpleOpenNiController extends PApplet {
...
public void setup(){
  ...
  stroke(255);
  smooth();
  perspective(radians(45),PApplet.parseFloat(width)/PApplet.parseFloat(height),10,150000);
}
...
public void onLostUser(int userId){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "simpleOpenNiController" };
    if (passedArgs != null) {
